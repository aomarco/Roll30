...
export const WEAPONS = [
  ...
  weapon({
    ...
    hands: "two",
    // House-ruled to battle-map scale (SRD 80/320): 12/24 squares.
    normalRange: 60,
    longRange: 120,
  ...
  weapon({
    ...
    hands: "one",
    // House-ruled to battle-map scale (SRD 30/120): 6/12 squares.
    normalRange: 30,
    longRange: 60,
  ...
  weapon({
    ...
    hands: "one",
    // House-ruled to battle-map scale (SRD 25/100): 5/10 squares.
    normalRange: 25,
    longRange: 50,
  ...
  weapon({
    ...
    hands: "one",
    // House-ruled to battle-map scale (SRD 30/120): 8/16 squares.
    normalRange: 40,
    longRange: 80,
    ammunition: "crossbow-bolt",
  ...
  weapon({
    ...
    hands: "two",
    // House-ruled to battle-map scale (SRD 100/400): 16/32 squares.
    normalRange: 80,
    longRange: 160,
    ammunition: "crossbow-bolt",
    cost: { quantity: 50, unit: "gp" },
