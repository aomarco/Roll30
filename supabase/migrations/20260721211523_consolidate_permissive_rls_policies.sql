...
drop policy if exists "gms manage assets" on public.campaign_assets;
...
drop policy if exists "gms manage memberships" on public.campaign_members;
drop policy if exists "owners add initial gm membership" on public.campaign_members;
...
drop policy if exists "owners read owned campaigns" on public.campaigns;
...
drop policy if exists "gms manage inventory" on public.character_inventory;
...
drop policy if exists "gms manage characters" on public.characters;
drop policy if exists "players create owned player characters" on public.characters;
drop policy if exists "players update owned character" on public.characters;
drop policy if exists "players delete owned player characters" on public.characters;
...
drop policy if exists "gms manage items" on public.items;
...
drop policy if exists "campaign members read table profiles" on public.profiles;
...
drop policy if exists "respond to permitted prompts" on public.prompt_responses;
drop policy if exists "gms read campaign prompt responses" on public.prompt_responses;
...
drop policy if exists "gms manage prompts" on public.prompts;
...
drop policy if exists "gms manage secure map tiles" on public.scene_map_tiles;
...
drop policy if exists "gms manage scene objects" on public.scene_objects;
...
drop policy if exists "gms manage scene templates" on public.scene_templates;
...
drop policy if exists "gms manage triggers" on public.scene_triggers;
...
drop policy if exists "gms manage scenes" on public.scenes;
...
drop policy if exists "gms manage snapshots" on public.session_snapshots;
...
drop policy if exists "gms manage session tokens" on public.session_tokens;
...
drop policy if exists "gms manage sessions" on public.sessions;
...
drop policy if exists "gms manage stock" on public.shop_stock;
drop policy if exists "members read stock" on public.shop_stock;
drop policy if exists "members read available shop stock" on public.shop_stock;
...
drop policy if exists "gms manage shops" on public.shops;
