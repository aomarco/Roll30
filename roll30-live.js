(function () {
  ...
  function bind(view) {
    ...
    app.querySelectorAll('[data-add-token]').forEach(b => b.onclick = async () => {
      ...
      const state = current.state || {}; const tokens = [...(state.tokens || []), { id:crypto.randomUUID(), character_id:b.dataset.addToken, name:b.dataset.tokenName, speed:Number(b.dataset.tokenSpeed) || 30, x:50, y:50 }];
